...
storms %>% 
  mutate(month = ifelse(month == 6, "June", 
                        ifelse(month == 7, "July", "Not June or July")))
```

Exercise:
For "diamonds", create a new column called "cut_quality"
...
```{r wrangle_q8, exrcise = TRUE}

```

```{r wrangle_q8-solution}
