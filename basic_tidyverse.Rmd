...
For "InsectSprays", filter for "count" greater than 10 and find the proportion of each type of "spray" (hint: use summarise(new_variable = mean(variable == value)))
...
InsectSprays %>% 
  filter(count > 10) %>% 
  summarise(spray_a_prop = mean(spray == "A"),
            spray_b_prop = mean(spray == "B"),
            spray_c_prop = mean(spray == "C"),
            spray_d_prop = mean(spray == "D"),
            spray_e_prop = mean(spray == "E"),
            spray_f_prop = mean(spray == "F"))
```
